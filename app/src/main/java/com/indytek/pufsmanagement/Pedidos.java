...
public class Pedidos extends AppCompatActivity {
    ...
    public void cargarPedidos(){
        ...
        productos.add(new Producto(1,"hamborgesa","https://cdn.computerhoy.com/sites/navi.axelspringer.es/public/media/image/2020/08/hamburguesa-2028707.jpg",12, Tipo.HAMBURGUESA,Rango.ORO));
        productos.add(new Producto(2,"papas","https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/hamburguesa-1590595900.jpg",12,Tipo.HAMBURGUESA,Rango.ORO));
        productos.add(new Producto(3,"perrito","https://sevilla.abc.es/gurme/wp-content/uploads/sites/24/2014/10/hamburguesas-960x540.jpg",12,Tipo.HAMBURGUESA,Rango.ORO));
        productos.add(new Producto(4,"cocacola 1L","https://media.revistagq.com/photos/5f08621564f52a842c7f9a83/master/pass/hamburguesa%20the%20fitzgerald.jpg",12,Tipo.HAMBURGUESA,Rango.ORO));
